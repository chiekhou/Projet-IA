...
import styles from "./RatingAndReview.module.scss";  // Assurez-vous d'importer le bon fichier CSS
  ...
  return (
    <div onClick={handleRemoveList} className={styles.container}>
      <div
        ...
        className={`${styles.ratingAndReview} ${remove ? styles.remove : ''}`}
      >
        <h4 className="mb-20">Notations et Avis</h4>
        <ul>
